...
@section('title', 'Add User | BitRain')
                ...
                <div class="card card-outline card-info mt-2">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="showBox" name="is_student">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="institution_id" name="institution_id" style="width: 100%"
                                    ...
                                    @foreach ($institutions as $institution)
                                        <option value="{{ $institution->id }}">{{ $institution->name }} ({{$institution->eiin}})</option>
                                    @endforeach
                                </select>
                ...
                <div class="card card-outline card-secondary">
                    ...
                    <div class="card-body text-center">
                        <img id="avatarPreview"
                             src="{{ asset('/storage/volt/noimage.png') }}"
                             alt="Avatar Preview"
